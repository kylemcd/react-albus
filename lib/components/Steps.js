...
var Steps = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Steps, [{
    ...
    value: function componentDidMount() {
      var steps = _react["default"].Children.map(this.props.children, function (_ref) {
        var _ref$props = _ref.props,
          children = _ref$props.children,
          render = _ref$props.render,
          config = _objectWithoutProperties(_ref$props, _excluded);
        return config;
      });
    ...
    value: function render() {
      var _ref2 = this.props.step || this.context.wizard.step,
        activeId = _ref2.id;
      var _React$Children$toArr = _react["default"].Children.toArray(this.props.children).filter(function (_ref3) {
