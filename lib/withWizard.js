...
var withWizard = function withWizard(Component) {
  ...
  WithWizard.displayName = "withWizard(".concat(Component.displayName || Component.name, ")");
  WithWizard.WrappedComponent = Component;
  return (0, _hoistNonReactStatics["default"])(WithWizard, Component);
};
var _default = withWizard;
